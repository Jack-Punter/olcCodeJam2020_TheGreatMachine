...
struct BlackBoxSPD1 : public BlackBoxCircuitNode {
    /* Number of inputs: 5 */
    /* Number of outputs: 5 */
...
struct SPD1Level : public Level {
    void OnUserCreate(olc::PixelGameEngine *_pge) {
        ...
        CircuitNode *BlackBox = new BlackBoxSPD1();
