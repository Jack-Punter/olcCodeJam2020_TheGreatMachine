#ifndef LEVEL_Simple4
#define LEVEL_Simple4

struct BlackBoxNand : public BlackBoxCircuitNode {
    /* Number of inputs: 2 */
    /* Number of outputs: 1 */
...
struct NandLevel : public Level {
    void OnUserCreate(olc::PixelGameEngine *_pge) {
        ...
        CircuitNode *BlackBox = new BlackBoxNand();
