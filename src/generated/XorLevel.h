#ifndef LEVEL_Simple3
#define LEVEL_Simple3

struct BlackBoxXOR : public BlackBoxCircuitNode {
    /* Number of inputs: 2 */
    /* Number of outputs: 1 */
...
struct XorLevel : public Level {
    void OnUserCreate(olc::PixelGameEngine *_pge) {
        ...
        CircuitNode *BlackBox = new BlackBoxXOR();
