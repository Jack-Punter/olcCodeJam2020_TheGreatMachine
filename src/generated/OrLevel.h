#ifndef LEVEL_Simple2
#define LEVEL_Simple2

struct BlackBoxOr : public BlackBoxCircuitNode {
    /* Number of inputs: 2 */
    /* Number of outputs: 1 */
...
struct OrLevel : public Level {
    void OnUserCreate(olc::PixelGameEngine *_pge) {
        ...
        CircuitNode *BlackBox = new BlackBoxOr();
