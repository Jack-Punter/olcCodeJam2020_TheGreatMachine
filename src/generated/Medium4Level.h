#ifndef LEVEL_Medium4
#define LEVEL_Medium4

struct BlackBoxMedium4 : public BlackBoxCircuitNode {
    /* Number of inputs: 4 */
    /* Number of outputs: 1 */
...
struct Medium4Level : public Level {
    void OnUserCreate(olc::PixelGameEngine *_pge) {
        ...
        CircuitNode *BlackBox = new BlackBoxMedium4();
