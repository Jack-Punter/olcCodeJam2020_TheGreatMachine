#ifndef LEVEL_Medium6
#define LEVEL_Medium6

struct BlackBoxMedium6 : public BlackBoxCircuitNode {
    /* Number of inputs: 5 */
    /* Number of outputs: 4 */
...
struct Medium6Level : public Level {
    void OnUserCreate(olc::PixelGameEngine *_pge) {
        ...
        CircuitNode *BlackBox = new BlackBoxMedium6();
