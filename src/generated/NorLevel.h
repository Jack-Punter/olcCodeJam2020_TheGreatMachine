#ifndef LEVEL_Simple5
#define LEVEL_Simple5

struct BlackBoxNor : public BlackBoxCircuitNode {
    /* Number of inputs: 2 */
    /* Number of outputs: 1 */
...
struct NorLevel : public Level {
    void OnUserCreate(olc::PixelGameEngine *_pge) {
        ...
        CircuitNode *BlackBox = new BlackBoxNor();
