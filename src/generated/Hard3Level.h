...
struct BlackBoxHard3 : public BlackBoxCircuitNode {
    /* Number of inputs: 4 */
    /* Number of outputs: 6 */
...
struct Hard3Level : public Level {
    void OnUserCreate(olc::PixelGameEngine *_pge) {
        ...
        CircuitNode *BlackBox = new BlackBoxHard3();
