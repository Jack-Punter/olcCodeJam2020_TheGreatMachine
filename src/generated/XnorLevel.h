#ifndef LEVEL_Simple6
#define LEVEL_Simple6

struct BlackBoxXNOR : public BlackBoxCircuitNode {
    /* Number of inputs: 2 */
    /* Number of outputs: 1 */
...
struct XnorLevel : public Level {
    void OnUserCreate(olc::PixelGameEngine *_pge) {
        ...
        CircuitNode *BlackBox = new BlackBoxXNOR();
